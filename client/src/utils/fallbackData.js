export const fallbackProducts = [
  ...
  {
    _id: 'prod_bengal_tant_1',
    name: "Traditional Bengal Handloom Tant Cotton Saree",
    slug: "traditional-bengal-handloom-tant-cotton-saree",
    description: "Lightweight authentic Bengal Tant cotton saree with soft woven border. Ideal for daily elegance and summer festive wear.",
    price: 1450,
    originalPrice: 1650,
    discount: 12,
    category: "Handloom Cotton",
...
export const fallbackOrders = [
  {
    _id: 'VSN-7849201',
    user: { name: 'Priya Sundaram', email: 'customer@example.com' },
    items: [
      {
        name: 'Royal Crimson Kanjivaram Pure Silk Saree',
